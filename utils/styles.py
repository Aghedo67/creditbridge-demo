...
def inject_css():
    ...
    .metric-card:hover { border-color: rgba(100,255,218,0.27); }
    .metric-label {
        font-size: 0.75rem;
        color: #8892b0;
        text-transform: uppercase;
    ...
    /* ── Streamlit overrides ──────────────────────────── */
    .stButton > button {
        background: linear-gradient(135deg, rgba(100,255,218,0.13), rgba(14,165,233,0.13));
        border: 1px solid rgba(100,255,218,0.40);
        color: #64ffda;
        border-radius: 8px;
        font-family: 'DM Sans', sans-serif;
        font-weight: 500;
    ...
    .stButton > button:hover {
        background: linear-gradient(135deg, rgba(100,255,218,0.20), rgba(14,165,233,0.20));
        border-color: #64ffda;
    ...
    .stButton > button[kind="primary"]:hover {
        ...
        box-shadow: 0 8px 24px rgba(100,255,218,0.20);
    }
