        ...
        if run or preset_name != "— Enter manually —":
            ...
            fig = go.Figure(go.Indicator(
                ...
                gauge={
                    ...
                    "borderwidth":0,
                    "steps":[
                        {"range":[150,299],"color":"rgba(248,113,113,0.13)"},
                        {"range":[299,449],"color":"rgba(249,115,22,0.13)"},
                        {"range":[449,599],"color":"rgba(251,191,36,0.13)"},
                        {"range":[599,749],"color":"rgba(74,222,128,0.13)"},
                        {"range":[749,850],"color":"rgba(100,255,218,0.13)"},
                    ],
